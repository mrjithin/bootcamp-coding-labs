...
public:
   ...
   */
   friend unique_ptr operator==(const unique_ptr& lhs, const unique_ptr& rhs){
    return lhs.ptr==rhs.ptr;
   }
   friend unique_ptr operator==(nullptr_t, const unique_ptr& rhs){
    return nullptr==rhs.ptr;
   }
   friend unique_ptr operator==(const unique_ptr& lhs,nullptr_t){
    return nullptr==lhs.ptr;
   }
};
